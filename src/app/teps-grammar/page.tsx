...
import {
  ...
  Trophy, RotateCcw, List, GraduationCap, CalendarDays,
} from "lucide-react";
...
// grammar용 seed는 vocab과 다르게 +1 offset을 줘서 매일 다른 조합이 나오게
const STORAGE_KEY = `teps-grammar-daily-${todayStr}`;
const questions = getDailyQuestions(parseInt(todayStr.replace(/-/g, ""), 10) + 1);
    ...
    return (
      <div className="mx-auto max-w-2xl space-y-6">
        ...
        >
          ...
          <p className="mt-1 text-sm text-[var(--muted-foreground)]">{getDisplayDate()} · TEPS 문법</p>
      ...
      <div className="-mx-4 -mt-4 md:-mx-8 md:-mt-8 mb-0 overflow-hidden rounded-2xl border border-[var(--border)] bg-[var(--card)] px-4 md:px-8 pb-5 md:pb-6 pt-5 md:pt-8 shadow-sm">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-[var(--foreground)]">오늘의 TEPS 문법</h1>
